...
// Delete with a confirmation modal - requires typing the organization name (or
        ...
        >
          ...
          >
            ...
            <p className="mt-1 text-sm text-neutral-500">
              ...
              knowledge. Its assistants are kept but detached. Type{" "}
              <span className="font-medium text-neutral-800">{name}</span> or{" "}
            ...
            <div className="mt-5 flex justify-end gap-2">
              ...
              <form action={deleteOrganizationAction}>
                ...
                <SubmitButton variant="danger" pendingText="Deleting…" disabled={!confirmed}>
                  Delete
                </SubmitButton>
              </form>
            </div>
