...
export function TopicModal({
  ...
  return (
    <>
      <div className="shape-card glass flex items-start justify-between gap-3 p-4">
        <div className="min-w-0">
          <p className="text-sm font-medium text-neutral-900">{title}</p>
          <p className="mt-0.5 truncate text-xs text-neutral-500">{summary || subtitle}</p>
        </div>
        <div className="flex shrink-0 items-center gap-2">
          ...
          <button
            ...
            className="press h-8 rounded-lg border border-neutral-200 bg-white px-3 text-xs font-medium text-neutral-700 hover:bg-neutral-50"
          >
            {a.edit}
          </button>
        </div>
