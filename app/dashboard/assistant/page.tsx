...
export default async function AssistantsPage({
  ...
  const isEmpty = assistants.length === 0 && !loadError;

  return (
    <div className="space-y-6">
      <PageHeader
        title="Assistants"
        description="The voice that answers your phone numbers."
      />
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-1 max-w-lg text-sm text-neutral-500">
                An assistant is the AI voice that answers a phone number. Name it, give it a number,
