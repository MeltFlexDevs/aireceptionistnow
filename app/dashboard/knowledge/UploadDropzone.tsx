...
export function UploadDropzone() {
  ...
  return (
    <label
      htmlFor="kn_pdf"
      aria-busy={pending}
      className={`relative flex min-w-64 flex-1 cursor-pointer flex-col items-center justify-center gap-0.5 rounded-xl border border-dashed px-4 py-3 text-center transition-colors ${
        pending
