...
import { assistantIdentity } from "./personality";
...
export default async function OnboardingPage({
  ...
  const firstIncomplete = !(cfg.companyName && cfg.assistantName)
    ? 1
    : !cfg.knowledgeDone
      ? 2
      : !cfg.calendarDone
    ...
    <div className="flex min-h-screen w-full flex-col">
      ...
      >
        ...
        {goView ? (
          ...
          <>
            <StepCompanion {...assistant} role={o.role} title={o.step4Title} sub="" />
            <PlanStep />
          </>
        )}
      </main>
