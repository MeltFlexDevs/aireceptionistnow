...
export async function CalendarStep({
  ...
  return (
    <div className="mx-auto w-full max-w-md">
      <div className="shape-card glass relative flex h-[min(37rem,calc(100dvh_-_13.5rem))] flex-col px-5 pb-6 pt-7 sm:h-[min(37rem,calc(100dvh_-_11.5rem))] sm:px-7 sm:pb-7">
