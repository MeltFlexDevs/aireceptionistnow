...
const description =
  "Short, straight answers to the questions people actually ask about AI receptionists: call transfer, your existing number, booking, languages, and more.";
...
export const metadata: Metadata = {
  ...
  // See pricing: an absent twitter block inherits the root homepage card.
  twitter: {
