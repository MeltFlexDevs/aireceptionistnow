...
export default async function AnswerPage({
  ...
  const jsonLd = [
    // Article, not QAPage: this is single-author, bylined, dated editorial.
    // Google reserves QAPage for user-submitted multi-answer forum content, so
    // marking editorial as QAPage risks dropped eligibility; Article is both
    // accurate and a rich-result-eligible type.
    {
      ...
      datePublished: `${a.date}T00:00:00+00:00`,
