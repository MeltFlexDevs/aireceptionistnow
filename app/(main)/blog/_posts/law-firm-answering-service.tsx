...
export const meta = {
  ...
  description:
    "An answering service for lawyers that picks up every potential client 24/7, runs intake and conflict capture, books consults, and respects your ethics rules.",
  date: "2026-06-30",
  updated: "2026-07-21",
