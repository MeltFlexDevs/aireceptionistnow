          ...
          <ul className="mt-4 space-y-2">
            {rows.map((code) => {
              ...
              return (
                ...
                >
                  <span className="flex w-20 shrink-0 items-center gap-2 text-sm font-medium text-neutral-800 sm:w-28">
                  ...
                  <button
                    ...
                    className="press flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-neutral-400 hover:bg-neutral-100 hover:text-neutral-700 sm:h-8 sm:w-8"
                  >
