                ...
                <li key={v.voiceId} role="option" aria-selected={v.voiceId === selected}>
                  ...
                  >
                    <button
                      ...
                      className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-neutral-200 text-neutral-700 transition-colors hover:bg-white disabled:opacity-30 sm:h-7 sm:w-7"
                    >
                      {playingId === v.voiceId ? (
